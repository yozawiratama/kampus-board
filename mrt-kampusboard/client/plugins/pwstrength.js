    ...
    var options = {
        ...
        setProgressBar = function ($el, score) {
            ...
            if (score < options.scores[0]) {
                progressbar.find(".progress-bar").css("width", "15%").addClass("progress-bar-danger").removeClass("progress-bar-warning").removeClass("progress-bar-success");
                if (options.showVerdicts) {
